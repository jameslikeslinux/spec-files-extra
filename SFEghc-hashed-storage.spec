#
# spec file for package SFEghc-hashed-storage
#
...
SUNW_Pkg:		 SFEghc-hashed-storage
...
Requires: SFEghc-dataenc
Requires: SFEghc-mmap
...
%package -n SFEghc-hashed-storage-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-hashed-storage

%package -n SFEghc-hashed-storage-doc
...
%post -n SFEghc-hashed-storage-doc
...
%postun -n SFEghc-hashed-storage-doc
...
%files -n SFEghc-hashed-storage-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-hashed-storage-doc -f pkg-doc.files
%defattr(-,root,root,-)
