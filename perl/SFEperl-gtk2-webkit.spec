#
# spec file for package SFEperl-gtk2-webkit
#
# includes module(s): perl-gtk2-webkit
#
...
Name:                    SFEperl-gtk2-webkit
Summary:                 Gtk2-WebKit-%{tarball_version} PERL Module
Version:                 %{perl_version}.%{tarball_version}
Source:                  http://www.cpan.org/modules/by-module/Gtk2/Gtk2-WebKit-%{tarball_version}.tar.gz
...
cd Gtk2-WebKit-%{tarball_version}
