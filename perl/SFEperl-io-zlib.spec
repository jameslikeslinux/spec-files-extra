...
Summary:                 IO-Zlib-%{io_zlib_version} PERL module
Version:                 %{perl_version}.%{io_zlib_version}
Source:                  http://www.cpan.org/modules/by-module/IO/IO-Zlib-%{io_zlib_version}.tar.gz
