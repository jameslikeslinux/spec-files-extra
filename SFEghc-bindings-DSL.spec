#
# spec file for package SFEghc-bindings-DSL
#
...
Name:                    bindings-DSL
Summary:                 bindings-DSL - FFI domain specific language, on top of hsc2hs
Version:                 1.0.6
Release:                 1
License:                 BSD
...
%package -n SFEghc-bindings-DSL-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-bindings-DSL

%package -n SFEghc-bindings-DSL-doc
...
%post -n SFEghc-bindings-DSL-doc
...
%postun -n SFEghc-bindings-DSL-doc
if [ "$1" -eq 0 ] ; then
  cd %{_docdir}/ghc/html/libraries && [ -x "./gen_contents_index" ] && ./gen_contents_index
fi
...
%files -n SFEghc-bindings-DSL-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-bindings-DSL-doc -f pkg-doc.files
%defattr(-,root,root,-)
