#
# spec file for package SFEghc-HList
#
...
records, type-indexed products (TIP) and co-products; licensed under
the MIT X License.

%package -n SFEghc-HList-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-HList

%package -n SFEghc-HList-doc
...
%files -n SFEghc-HList-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-HList-doc -f pkg-doc.files
%defattr(-,root,root,-)
