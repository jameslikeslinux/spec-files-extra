#
# spec file for package SFEghc-dyre
#
...
Name:                    dyre
Summary:                 dyre - Dynamic reconfiguration in Haskell
Version:                 0.8.2
Release:                 1
License:                 BSD
...
Requires: SFEghc-io-storage.spec
Requires: SFEghc-xdg-basedir.spec
...
%files -n SFEghc-dyre-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-dyre-doc -f pkg-doc.files
%defattr(-,root,root,-)
