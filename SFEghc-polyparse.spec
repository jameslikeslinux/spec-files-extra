#
# spec file for package SFEghc-polyparse
#
...
Name:                    polyparse
Summary:                 polyparse - A variety of alternative parser combinator libraries.
Version:                 1.4
Release:                 1
License:                 LGPL
...
class, for better deserialisation of Haskell values from Strings.

%package -n SFEghc-polyparse-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-polyparse

%package -n SFEghc-polyparse-doc
...
%files -n SFEghc-polyparse-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-polyparse-doc -f pkg-doc.files
%defattr(-,root,root,-)
