#
# spec file for package SFEghc-Boolean
#
...
Name:                    Boolean
Summary:                 Boolean - Generalized booleans
Version:                 0.0.1
Release:                 1
License:                 BSD
...
%files -n SFEghc-Boolean-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-Boolean-doc -f pkg-doc.files
%defattr(-,root,root,-)
