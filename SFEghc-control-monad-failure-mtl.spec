#
# spec file for package SFEghc-control-monad-failure-mtl
#
...
Summary:                 control-monad-failure-mtl - A class for monads which can fail with an error.
Version:                 0.7.0
Release:                 1
...
URL:                     http://github.com/pepeiborra/control-monad-failure
Source:                  http://hackage.haskell.org/packages/archive/%{name}/%{version}/%{name}-%{version}.tar.gz
SUNW_Pkg:		 SFEghc-c-monad-failure-mtl
...
%package -n SFEghc-c-monad-failure-mtl-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-c-monad-failure-mtl

%package -n SFEghc-c-monad-failure-mtl-doc
...
%post -n SFEghc-c-monad-failure-mtl-doc
...
%postun -n SFEghc-c-monad-failure-mtl-doc
...
%files -n SFEghc-c-monad-failure-mtl-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-c-monad-failure-mtl-doc -f pkg-doc.files
%defattr(-,root,root,-)
