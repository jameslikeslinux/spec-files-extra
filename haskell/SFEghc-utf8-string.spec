#
# spec file for package SFEghc-utf8-string
#
...
Name:                    utf8-string
Summary:                 utf8-string - Support for reading and writing UTF8 Strings
Version:                 0.3.6
Release:                 1
License:                 BSD
...
URL:                     http://www.cs.uu.nl/wiki/bin/view/Center/utf8-string
Source:                  http://hackage.haskell.org/packages/archive/%{name}/%{version}/%{name}-%{version}.tar.gz
SUNW_Pkg:		 SFEghc-utf8-string
...
%package -n SFEghc-utf8-string-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-utf8-string

%package -n SFEghc-utf8-string-doc
...
%postun -n SFEghc-utf8-string-doc
...
%files -n SFEghc-utf8-string-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-utf8-string-doc -f pkg-doc.files
%defattr(-,root,root,-)
