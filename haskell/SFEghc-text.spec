#
# spec file for package SFEghc-text
#
...
Name:                    text
Summary:                 text - An efficient packed Unicode text type
Version:                 0.7.2.1
Release:                 1
License:                 BSD
...
%files -n SFEghc-text-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-text-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Bump from 0.7.1.0 to 0.7.2.1.
* Thu May 06 2010 - markwright@internode.on.net
- Initial Solaris version 0.7.1.0
