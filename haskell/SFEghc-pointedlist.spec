#
# spec file for package SFEghc-pointedlist
#
...
Name:                    pointedlist
Summary:                 pointedlist - A zipper-like comonad which works as a list, tracking a position.
Version:                 0.4.0
Release:                 1
License:                 BSD
...
%package -n SFEghc-pointedlist-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-pointedlist

%package -n SFEghc-pointedlist-doc
...
%postun -n SFEghc-pointedlist-doc
...
%files -n SFEghc-pointedlist-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-pointedlist-doc -f pkg-doc.files
%defattr(-,root,root,-)
