#
# spec file for package SFEghc-safe
#
...
Name:                    safe
Summary:                 safe - Library for safe (pattern match free) functions
Version:                 0.2
Release:                 1
License:                 BSD
...
to return more descriptive error messages, programmer defined error
messages, Maybe wrapped results and default values. These functions
can be used to reduce the number of unsafe pattern matches in your
code.

%package -n SFEghc-safe-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-safe

%package -n SFEghc-safe-doc
...
%files -n SFEghc-safe-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-safe-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
* Sat Jul 3 2010 - markwright@internode.on.net
