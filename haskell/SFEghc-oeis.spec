#
# spec file for package SFEghc-oeis
#
...
Name:                    oeis
Summary:                 oeis - Interface to the Online Encyclopedia of Integer Sequences
Version:                 0.2.2
Release:                 1
License:                 BSD
...
%package -n SFEghc-oeis-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-oeis

%package -n SFEghc-oeis-doc
...
%files -n SFEghc-oeis-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-oeis-doc -f pkg-doc.files
%defattr(-,root,root,-)
