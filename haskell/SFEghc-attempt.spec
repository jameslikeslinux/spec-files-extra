#
# spec file for package SFEghc-attempt
#
...
Name:                    attempt
Summary:                 attempt - Concrete data type for handling extensible exceptions as failures.
Version:                 0.3.0
Release:                 1
License:                 BSD
...
%files -n SFEghc-attempt-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-attempt-doc -f pkg-doc.files
%defattr(-,root,root,-)
