#
# spec file for package SFEghc-encoding
#
...
Name:                    encoding
Summary:                 encoding - A library for various character encodings
Version:                 0.6.3
Release:                 1
License:                 BSD
...
Requires: SFEghc-HaXml

%description
Haskell has excellect handling of unicode, the Char type covers all
unicode chars. Unfortunatly, there is no possibility to read or write
...
%package -n SFEghc-encoding-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-encoding

%package -n SFEghc-encoding-doc
...
%files -n SFEghc-encoding-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-encoding-doc -f pkg-doc.files
%defattr(-,root,root,-)
