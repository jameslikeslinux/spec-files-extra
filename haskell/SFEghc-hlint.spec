#
# spec file for package SFEghc-hlint
#
...
%package -n SFEghc-hlint-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-hlint

%package -n SFEghc-hlint-doc
...
%files -n SFEghc-hlint-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-hlint-doc -f pkg-doc.files
%defattr(-,root,root,-)
