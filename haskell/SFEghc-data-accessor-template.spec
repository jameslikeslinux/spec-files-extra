#
# spec file for package SFEghc-data-accessor-template
#
...
Summary:                 data-accessor-template - Utilities for accessing and manipulating fields of records
Version:                 0.2.1.3
Release:                 1
License:                 BSD
...
SUNW_Pkg:		 SFEghc-data-a-template
...
%package -n SFEghc-data-a-template-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-data-a-template

%package -n SFEghc-data-a-template-doc
...
%post -n SFEghc-data-a-template-doc
...
%postun -n SFEghc-data-a-template-doc
...
%files -n SFEghc-data-a-template-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-data-a-template-doc -f pkg-doc.files
%defattr(-,root,root,-)
