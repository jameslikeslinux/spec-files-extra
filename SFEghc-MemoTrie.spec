#
# spec file for package SFEghc-MemoTrie
#
...
Name:                    MemoTrie
Summary:                 MemoTrie - Trie-based memo functions
Version:                 0.4.7
Release:                 1
License:                 BSD
...
using tries. It is based on some code I got from Spencer Janssen.

Project wiki page: http://haskell.org/haskellwiki/MemoTrie

%package -n SFEghc-MemoTrie-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-MemoTrie

%package -n SFEghc-MemoTrie-doc
...
%files -n SFEghc-MemoTrie-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-MemoTrie-doc -f pkg-doc.files
%defattr(-,root,root,-)
