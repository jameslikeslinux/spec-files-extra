...
%define module_version_download 1.10
%define module_package_name io-zlib

Name:                    SFEperl-io-zlib
IPS_package_name:        library/perl-5/%{module_package_name}
Summary:                 IO-Zlib-%{module_version_download} PERL module
...
%build
cd IO-Zlib-%{module_version_download}
perl Makefile.PL \
