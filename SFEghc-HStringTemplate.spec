#
# spec file for package SFEghc-HStringTemplate
#
...
Summary:                 HStringTemplate - StringTemplate implementation in Haskell.
Version:                 0.6.4
Release:                 1
License:                 BSD
...
SUNW_Pkg:		 SFEghc-HStringTemplate
...
%package -n SFEghc-HStringTemplate-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-HStringTemplate

%package -n SFEghc-HStringTemplate-doc
...
%post -n SFEghc-HStringTemplate-doc
...
%postun -n SFEghc-HStringTemplate-doc
...
%files -n SFEghc-HStringTemplate-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-HStringTemplate-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Bump from 0.6.3 to 0.6.4.
* Sun May 23 2010 - markwright@internode.on.net
- Initial Solaris version 0.6.3
