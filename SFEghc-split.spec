#
# spec file for package SFEghc-split
#
...
%files -n SFEghc-split-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-split-doc -f pkg-doc.files
%defattr(-,root,root,-)
