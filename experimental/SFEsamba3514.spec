...
Name:                    SFEsamba35
IPS_package_name:	 sfe/service/network/samba
...
export CFLAGS="-g -mt %optflags -L$LIBSCOMPILETIME:/usr/gnu/lib/samba -R /usr/gnu/lib/samba"
export CXXFLAGS="%cxx_optflags -L$LIBSCOMPILETIME:/usr/gnu/lib/samba -R /usr/gnu/lib/samba"
export LDFLAGS="-z ignore %_ldflags -L$LIBSCOMPILETIME:/usr/gnu/lib/samba -R /usr/gnu/lib/samba"


cd source3
export CONFIG_SHELL=/usr/bin/bash
./autogen.sh
CONFIG_SHELL=/usr/bin/bash bash ./configure --prefix=%{_prefix}  \
            --mandir=%{_mandir}   \
            --bindir=%{_bindir}         \
            --sbindir=%{_sbindir}         \
	    ...
	    --with-swatdir=%{_datadir}/samba/swat \
            ...
            --enable-fhs \
            SHELL=/usr/bin/bash     \
            LDFLAGS="-L$LIBSCOMPILETIME:/usr/gnu/lib/samba -R /usr/gnu/lib/samba "
