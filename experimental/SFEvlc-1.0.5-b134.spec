...
GNULIB="-L%{_libdir} -R%{_libdir} -L/usr/gnu/lib -R/usr/gnu/lib"

##evil!!! export PATH=$PATH:%{_bindir}:/usr/gnu/bin
...
#
export CXXFLAGS="%cxx_optflags -D_XPG4_2 -D__C99FEATURES__ -D__EXTENSIONS__ -L/lib -R/lib -L%{_libdir} -R%{_libdir}"
export CFLAGS="%optflags -D_XPG4_2 -D__C99FEATURES__ -D__EXTENSIONS__ -L/lib -R/lib -L%{_libdir} -R%{_libdir}"
export CPPFLAGS="-I/usr/X11/include -I%{_includedir} -I/usr/gnu/include -I/usr/include/libavcodec -I./include -D_XPG4_2 -D__C99FEATURES__ -D__EXTENSIONS__"
...
ln -s %{_includedir}/libavcodec include/ffmpeg
