#
# spec file for package SFEghc-Diff
#
...
Name:                    Diff
Summary:                 Diff - O(ND) diff algorithm in haskell.
Version:                 0.1.2
Release:                 1
License:                 BSD
...
comm -23 pkg-all-sort.files pkg-prof-sort.files > ghc-extra.files
...
%files -n SFEghc-Diff-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-Diff-doc -f pkg-doc.files
%defattr(-,root,root,-)
