#
# spec file for package SFEghc-cautious-file
#
...
Name:                    cautious-file
Summary:                 cautious-file - Ways to write a file cautiously
Version:                 0.1.5
Release:                 1
License:                 BSD
...
%package -n SFEghc-cautious-file-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-cautious-file

%package -n SFEghc-cautious-file-doc
...
%post -n SFEghc-cautious-file-doc
...
%postun -n SFEghc-cautious-file-doc
if [ "$1" -eq 0 ] ; then
  cd %{_docdir}/ghc/html/libraries && [ -x "./gen_contents_index" ] && ./gen_contents_index
fi
...
%files -n SFEghc-cautious-file-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-cautious-file-doc -f pkg-doc.files
%defattr(-,root,root,-)
