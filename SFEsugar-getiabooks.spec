#
# spec file for package SFEsugar-getiabooks
#
# includes module(s): sugar-getiabooks
#

%define pythonver 2.6

%include Solaris.inc
Name:                    SFEsugar-getiabooks
Summary:                 Sugar GetIABooks
URL:                     http://www.sugarlabs.org/
Version:                 3 
Source:                  http://download.sugarlabs.org/sources/honey/GetIABooks/GetIABooks-%{version}.tar.bz2
