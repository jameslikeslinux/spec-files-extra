#
# spec file for package SFEghc-monads-tf
#
...
Name:                    monads-tf
Summary:                 monads-tf - Monad classes, using type families
Version:                 0.1.0.0
Release:                 1
License:                 BSD
...
This package is almost a compatible replacement for the mtl-tf
package.

%package -n SFEghc-monads-tf-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-monads-tf

%package -n SFEghc-monads-tf-doc
...
%files -n SFEghc-monads-tf-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-monads-tf-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Initial Solaris version 0.1.0.0
