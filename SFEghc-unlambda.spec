#
# spec file for package SFEghc-unlambda
#
...
Name:                    unlambda
Summary:                 unlambda - Unlambda interpreter
Version:                 0.1
Release:                 1
License:                 GPL
...
%package -n SFEghc-unlambda-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-unlambda

%package -n SFEghc-unlambda-doc
...
runghc ./Setup.hs haddock ${VERBOSE} --hoogle
...
%files -n SFEghc-unlambda-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-unlambda-doc -f pkg-doc.files
%defattr(-,root,root,-)
