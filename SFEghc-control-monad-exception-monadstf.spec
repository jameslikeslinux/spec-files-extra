#
# spec file for package SFEghc-control-monad-exception-monadstf
#
...
Summary:                 control-monad-exception-monadstf - Monads-tf instances for the EMT exceptions monad transformer
Version:                 0.9
Release:                 1
...
URL:                     http://github.com/pepeiborra/control-monad-exception
Source:                  http://hackage.haskell.org/packages/archive/%{name}/%{version}/%{name}-%{version}.tar.gz
SUNW_Pkg:		 SFEghc-c-monad-e-monadstf
...
Requires: SFEghc-monads-tf

%description
Monads-tf instances for the EMT exceptions monad transformer

%package -n SFEghc-c-monad-e-monadstf-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-c-monad-e-monadstf

%package -n SFEghc-c-monad-e-monadstf-doc
...
%post -n SFEghc-c-monad-e-monadstf-doc
...
%postun -n SFEghc-c-monad-e-monadstf-doc
...
%files -n SFEghc-c-monad-e-monadstf-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-c-monad-e-monadstf-doc -f pkg-doc.files
%defattr(-,root,root,-)
