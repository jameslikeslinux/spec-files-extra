#
# spec file for package SFEghc-cpphs
#
...
%files -n SFEghc-cpphs-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-cpphs-doc -f pkg-doc.files
%defattr(-,root,root,-)
