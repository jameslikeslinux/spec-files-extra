#
# spec file for package SFEghc-hoogle
#
...
Name:                    hoogle
Summary:                 hoogle - Haskell API Search
Version:                 4.0.7
Release:                 1
License:                 GPL
...
%package -n SFEghc-hoogle-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-hoogle

%package -n SFEghc-hoogle-doc
...
%files -n SFEghc-hoogle-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-hoogle-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
* Sat July 3 2010 - markwright@internode.on.net
- Initial Solaris version 4.0.7
