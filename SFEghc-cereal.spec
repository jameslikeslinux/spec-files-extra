#
# spec file for package SFEghc-cereal
#
...
Name:                    cereal
Summary:                 cereal - A binary serialization library
Version:                 0.2
Release:                 1
License:                 BSD
...
%files -n SFEghc-cereal-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-cereal-doc -f pkg-doc.files
%defattr(-,root,root,-)
