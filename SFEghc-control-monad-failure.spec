#
# spec file for package SFEghc-control-monad-failure
#
...
Summary:                 control-monad-failure - A class for monads which can fail with an error.
Version:                 0.7.0
Release:                 1
...
SUNW_Pkg:		 SFEghc-c-monad-failure
...
%package -n SFEghc-c-monad-failure-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-c-monad-failure

%package -n SFEghc-c-monad-failure-doc
...
%post -n SFEghc-c-monad-failure-doc
...
%postun -n SFEghc-c-monad-failure-doc
...
%files -n SFEghc-c-monad-failure-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-c-monad-failure-doc -f pkg-doc.files
%defattr(-,root,root,-)
