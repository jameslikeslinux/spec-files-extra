#
# spec file for package SFEghc-binary-strict
#
...
Name:                    binary-strict
Summary:                 binary-strict - Binary deserialisation using strict ByteStrings
Version:                 0.4.8
Release:                 1
License:                 BSD
...
%description
This is a strict version of the Get monad from the binary package. It
is pretty much just a copy and paste job from the original source
...
%package -n SFEghc-binary-strict-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-binary-strict

%package -n SFEghc-binary-strict-doc
...
%post -n SFEghc-binary-strict-doc
...
%postun -n SFEghc-binary-strict-doc
if [ "$1" -eq 0 ] ; then
  cd %{_docdir}/ghc/html/libraries && [ -x "./gen_contents_index" ] && ./gen_contents_index
fi
...
%files -n SFEghc-binary-strict-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-binary-strict-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
%changelog
* Sun Apr 25 2010 - markwright@internode.on.net
