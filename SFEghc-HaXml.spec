#
# spec file for package SFEghc-HaXml
#
...
%files -n SFEghc-HaXml-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-HaXml-doc -f pkg-doc.files
%defattr(-,root,root,-)
