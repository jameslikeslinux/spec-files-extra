#
# spec file for package SFEghc-rosezipper
#
...
%package -n SFEghc-rosezipper-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-rosezipper

%package -n SFEghc-rosezipper-doc
...
%files -n SFEghc-rosezipper-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-rosezipper-doc -f pkg-doc.files
%defattr(-,root,root,-)
