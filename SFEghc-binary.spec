#
# spec file for package SFEghc-binary
#
...
Name:                    binary
Summary:                 binary - Binary serialisation for Haskell values using lazy ByteStrings
Version:                 0.5.0.2
Release:                 1
License:                 BSD
...
%files -n SFEghc-binary-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-binary-doc -f pkg-doc.files
%defattr(-,root,root,-)
