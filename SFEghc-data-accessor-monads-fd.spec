#
# spec file for package SFEghc-data-a-monads-fd
#
...
Summary:                 data-accessor-monads-fd - Use Accessor to access state in monads-fd State monad class
Version:                 0.2.0.2
Release:                 1
License:                 BSD
...
SUNW_Pkg:		 SFEghc-data-a-monads-fd
...
%package -n SFEghc-data-a-monads-fd-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-data-a-monads-fd

%package -n SFEghc-data-a-monads-fd-doc
...
%post -n SFEghc-data-a-monads-fd-doc
...
%postun -n SFEghc-data-a-monads-fd-doc
...
%files -n SFEghc-data-a-monads-fd-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-data-a-monads-fd-doc -f pkg-doc.files
%defattr(-,root,root,-)
