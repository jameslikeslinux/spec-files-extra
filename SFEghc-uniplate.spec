#
# spec file for package SFEghc-uniplate
#
...
Data.Generics.Uniplate.Data with substantially higher performance
(around 5 times), but requires writing instance declarations.
...
%package -n SFEghc-uniplate-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-uniplate

%package -n SFEghc-uniplate-doc
...
%files -n SFEghc-uniplate-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-uniplate-doc -f pkg-doc.files
%defattr(-,root,root,-)
