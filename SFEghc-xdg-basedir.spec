#
# spec file for package SFEghc-xdg-basedir
#
...
Name:                    xdg-basedir
Summary:                 xdg-basedir - A basic implementation of the XDG Base Directory specification.
Version:                 0.2
Release:                 1
License:                 BSD
...
%package -n SFEghc-xdg-basedir-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-xdg-basedir

%package -n SFEghc-xdg-basedir-doc
...
%postun -n SFEghc-xdg-basedir-doc
if [ "$1" -eq 0 ] ; then
  cd %{_docdir}/ghc/html/libraries && [ -x "./gen_contents_index" ] && ./gen_contents_index
fi
...
%files -n SFEghc-xdg-basedir-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-xdg-basedir-doc -f pkg-doc.files
%defattr(-,root,root,-)
