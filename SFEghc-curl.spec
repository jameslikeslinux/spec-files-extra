#
# spec file for package SFEghc-curl
#
...
Name:                    curl
Summary:                 curl - Haskell binding to libcurl
Version:                 1.3.5
Release:                 1
License:                 BSD
...
%package -n SFEghc-curl-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-curl

%package -n SFEghc-curl-doc
...
%files -n SFEghc-curl-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-curl-doc -f pkg-doc.files
%defattr(-,root,root,-)
