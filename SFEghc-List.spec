#
# spec file for package SFEghc-List
#
...
Name:                    List
Summary:                 List - List monad transformer and class
Version:                 0.3.0
Release:                 1
License:                 BSD
...
%files -n SFEghc-List-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-List-doc -f pkg-doc.files
%defattr(-,root,root,-)
