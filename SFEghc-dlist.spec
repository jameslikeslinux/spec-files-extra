#
# spec file for package SFEghc-dlist
#
...
Name:                    dlist
Summary:                 dlist - Difference lists
Version:                 0.5
Release:                 1
License:                 BSD
...
%files -n SFEghc-dlist-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-dlist-doc -f pkg-doc.files
%defattr(-,root,root,-)
