#
# spec file for package SFEghc-tagsoup
#
...
Name:                    tagsoup
Summary:                 tagsoup - Parsing and extracting information from (possibly malformed) HTML/XML documents
Version:                 0.8
Release:                 1
License:                 BSD
...
find $RPM_BUILD_ROOT%{_libdir} $RPM_BUILD_ROOT%{_bindir} -type f -name "*" > pkg-all.files
...
%files -n SFEghc-tagsoup-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-tagsoup-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
* Sun Apr 4 2010 - markwright@internode.on.net
