#
# spec file for package SFEghc-control-monad-exception-mtl
#
...
Summary:                 control-monad-exception-mtl - MTL instances for the EMT exceptions monad transformer
Version:                 0.8.0.3
Release:                 1
...
%package -n SFEghc-c-monad-e-mtl-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-c-monad-e-mtl

%package -n SFEghc-c-monad-e-mtl-doc
...
%post -n SFEghc-c-monad-e-mtl-doc
...
%postun -n SFEghc-c-monad-e-mtl-doc
if [ "$1" -eq 0 ] ; then
  cd %{_docdir}/ghc/html/libraries && [ -x "./gen_contents_index" ] && ./gen_contents_index
fi
...
%files -n SFEghc-c-monad-e-mtl-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-c-monad-e-mtl-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Initial Solaris version 0.8.0.3
