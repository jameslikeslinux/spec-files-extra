#
# spec file for package SFEghc-readline
#
...
Name:                    readline
Summary:                 readline - An interface to the GNU readline library
Version:                 1.0.1.0
Release:                 1
License:                 BSD
...
%description
More information on readline can be found at http://www.gnu.org/directory/readline.html.

%package -n SFEghc-readline-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-readline

%package -n SFEghc-readline-doc
...
%files -n SFEghc-readline-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-readline-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
* Fri Jul 2 2010 - markwright@internode.on.net
- Initial Solaris version 0.2.2
