#
# spec file for package SFEghc-SyntaxMacros
#
...
Name:                    SyntaxMacros
Summary:                 SyntaxMacros - Syntax Macros in the form of an EDSL
Version:                 0.2
Release:                 1
License:                 LGPL
...
URL:                     http://www.cs.uu.nl/wiki/bin/view/Center/SyntaxMacros
Source:                  http://hackage.haskell.org/packages/archive/%{name}/%{version}/%{name}-%{version}.tar.gz
SUNW_Pkg:		 SFEghc-SyntaxMacros
...
%package -n SFEghc-SyntaxMacros-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-SyntaxMacros

%package -n SFEghc-SyntaxMacros-doc
...
sed -i -e 's,template-haskell>=2.4.0.1,template-haskell>=2.4.0.0,' SyntaxMacros.cabal
...
%post -n SFEghc-SyntaxMacros-doc
...
%postun -n SFEghc-SyntaxMacros-doc
...
%files -n SFEghc-SyntaxMacros-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-SyntaxMacros-doc -f pkg-doc.files
%defattr(-,root,root,-)
