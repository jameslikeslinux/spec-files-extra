...
%define module_version 6.3
%define module_version_download 6.03
%define module_name HTTP-Message

%include Solaris.inc
%include packagenamemacros.inc

Name:		SFEperl-http-message
IPS_Package_Name:	library/perl-5/libwww-perl-http-message
Summary:	HTTP Message PERL module
