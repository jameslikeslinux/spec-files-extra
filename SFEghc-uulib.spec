#
# spec file for package SFEghc-uulib
#
...
Name:                    uulib
Summary:                 uulib - Haskell Utrecht Tools Library
Version:                 0.9.12
Release:                 1
License:                 LGPL
...
%files -n SFEghc-uulib-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-uulib-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Initial Solaris version 0.9.12
