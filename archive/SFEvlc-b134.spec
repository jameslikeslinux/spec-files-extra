...
#GNULIB="-L/usr/gnu/lib -R/usr/gnu/lib -L%{_libdir} -R%{_libdir}"
GNULIB="-L%{_libdir} -R%{_libdir} -L/usr/gnu/lib -R/usr/gnu/lib"

# use gcc-4.3.3
export PATH=$PATH:/usr/gnu/bin
export ACLOCAL_FLAGS="-I %{_datadir}/aclocal -I/usr/share/aclocal"
export CC=/usr/gcc/4.3/bin/gcc
export CXX=/usr/gcc/4.3/bin/g++
export CPPFLAGS="-D_XOPEN_SOURCE=500 -D__EXTENSIONS__ -I/usr/X11/include -I/usr/gnu/include -I/usr/include/libavcodec -I./include -I%{_includedir}"
%if %debug_build
export CFLAGS="-g"
%else
export CFLAGS="-O4"
