#
# spec file for package SFEghc-failure
#
...
Name:                    failure
Summary:                 failure - A simple type class for success/failure computations.
Version:                 0.1.0
Release:                 1
...
%files -n SFEghc-failure-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-failure-doc -f pkg-doc.files
%defattr(-,root,root,-)
