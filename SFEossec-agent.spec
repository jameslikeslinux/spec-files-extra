#
# spec file for package SFEossec-agent
#
# includes module(s): ossec-agent
#
...
Name:                    SFEossec-agent
IPS_Package_Name:	 security/ossec-agent
...
Source2:                 ossec.xml
License: 		 GPLv2
Patch1:                  ossec-agent-01-installagent.diff
...
%changelog
* Sat Feb 25 2012- logan@gedanken.org
- Initial spec.
