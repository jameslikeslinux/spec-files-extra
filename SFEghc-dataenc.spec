#
# spec file for package SFEghc-dataenc
#
...
Name:                    dataenc
Summary:                 dataenc - Data encoding library
Version:                 0.13.0.2
Release:                 1
License:                 BSD
...
%files -n SFEghc-dataenc-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-dataenc-doc -f pkg-doc.files
%defattr(-,root,root,-)
...
- Bump from 0.13.0.2 to 0.13.0.3.
