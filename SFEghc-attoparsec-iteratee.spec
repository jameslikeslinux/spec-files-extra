#
# spec file for package SFEghc-attoparsec-iteratee
#
...
Summary:                 attoparsec-iteratee - An adapter to convert attoparsec Parsers into blazing-fast Iteratees
Version:                 0.1.1
Release:                 1
License:                 BSD
...
SUNW_Pkg:		 SFEghc-attoparsec-iteratee
...
Requires: SFEghc-iteratee
Requires: SFEghc-monads-fd

%description
An adapter to convert attoparsec Parsers into blazing-fast Iteratees

%package -n SFEghc-attoparsec-iteratee-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-attoparsec-iteratee

%package -n SFEghc-attoparsec-iteratee-doc
...
%post -n SFEghc-attoparsec-iteratee-doc
...
%postun -n SFEghc-attoparsec-iteratee-doc
...
%files -n SFEghc-attoparsec-iteratee-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-attoparsec-iteratee-doc -f pkg-doc.files
%defattr(-,root,root,-)
