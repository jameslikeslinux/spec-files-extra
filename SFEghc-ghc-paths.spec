#
# spec file for package SFEghc-ghc-paths
#
...
Name:                    ghc-paths
Summary:                 ghc-paths - Knowledge of GHCs installation directories
Version:                 0.1.0.6
Release:                 1
License:                 BSD
...
%description
Knowledge of GHCs installation directories

%package -n SFEghc-ghc-paths-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-ghc-paths

%package -n SFEghc-ghc-paths-doc
...
%files -n SFEghc-ghc-paths-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-ghc-paths-doc -f pkg-doc.files
%defattr(-,root,root,-)
