#
# spec file for package SFEghc-terminfo
#
...
Name:                    terminfo
Summary:                 terminfo - Haskell bindings to the terminfo library.
Version:                 0.3.1.2
Release:                 1
License:                 BSD
...
%package -n SFEghc-terminfo-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-terminfo

%package -n SFEghc-terminfo-doc
...
%files -n SFEghc-terminfo-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-terminfo-doc -f pkg-doc.files
%defattr(-,root,root,-)
