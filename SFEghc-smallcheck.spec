#
# spec file for package SFEghc-smallcheck
#
...
Name:                    smallcheck
Summary:                 smallcheck - Another lightweight testing library in Haskell.
Version:                 0.4
Release:                 1
License:                 GPL
...
%package -n SFEghc-smallcheck-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-smallcheck

%package -n SFEghc-smallcheck-doc
...
%postun -n SFEghc-smallcheck-doc
...
%files -n SFEghc-smallcheck-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-smallcheck-doc -f pkg-doc.files
%defattr(-,root,root,-)
