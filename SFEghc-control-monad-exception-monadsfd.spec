#
# spec file for package SFEghc-control-monad-exception-monadsfd
#
...
Summary:                 control-monad-exception-monadsfd - Monads-fd instances for the EMT exceptions monad transformer
Version:                 0.9
Release:                 1
...
URL:                     http://github.com/pepeiborra/control-monad-exception-monadsfd
Source:                  http://hackage.haskell.org/packages/archive/%{name}/%{version}/%{name}-%{version}.tar.gz
SUNW_Pkg:		 SFEghc-c-monad-e-monadsfd
...
%package -n SFEghc-c-monad-e-monadsfd-prof
Summary:                 %{summary} - profiling libraries
SUNW_BaseDir:            %{_basedir}
%include default-depend.inc
Requires: SFEghc-c-monad-e-monadsfd

%package -n SFEghc-c-monad-e-monadsfd-doc
...
%post -n SFEghc-c-monad-e-monadsfd-doc
...
%postun -n SFEghc-c-monad-e-monadsfd-doc
...
%files -n SFEghc-c-monad-e-monadsfd-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-c-monad-e-monadsfd-doc -f pkg-doc.files
%defattr(-,root,root,-)
