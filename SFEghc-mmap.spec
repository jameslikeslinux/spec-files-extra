#
# spec file for package SFEghc-mmap
#
...
Name:                    mmap
Summary:                 mmap - Memory mapped files for POSIX and Windows
# Version:               0.5.4 hashed-storage only compiles with 0.4.1
Version:                 0.4.1
Release:                 1
License:                 BSD
...
%files -n SFEghc-mmap-prof -f pkg-prof.files
%defattr (-, root, bin)

%files  -n SFEghc-mmap-doc -f pkg-doc.files
%defattr(-,root,root,-)
